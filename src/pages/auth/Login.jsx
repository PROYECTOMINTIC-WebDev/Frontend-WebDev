...
const Login = () => {
  ...
  return (
    <div className="flex  items-center justify-center w-full h-full">
      <div className=" flex bg-black bg-hero-pattern bg-cover w-6/12 relative h-full  "></div>
      <div className="w-3/12 relativeh-full mr-80 ml-32">
        ...
        <h1 className="text-gray-900 text-center m-5 text-3xl FuzzyBubbles font-black ml-36  flex flex-justify-between">
          Gestión de Proyectos WebDev
        </h1>

        <h1 className="text-xl font-bold text-gray-900 text-center ml-32"></h1>
        <form
        ...
        >
          ...
          <Input
            ...
            required={true}
          />
          {dataMutation && dataMutation.login.error ? (
            <div>
              <div
                class="float    flex flex-row bg-red-100 rounded-lg p-4 mb-4 text-sm text-red-700 dark:bg-red-200 dark:text-red-800"
                role="alert"
              >
                <svg
